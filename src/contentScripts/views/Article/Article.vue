...
function openArticle(lid: string) {
  window.open(`https://www.luogu.com.cn/article/${lid}`, '_blank')
}
</script>
      ...
      >
        ...
        >
          <div flex-1 min-w-0>
            ...
            <div flex="~ gap-2" mt-1 style="font-size: 0.8em; color: var(--bew-text-3)">
              <span :style="{ color: a.author?.color ? `var(--bew-${a.author.color})` : 'var(--bew-text-2)' }">{{
                a.author?.name
              }}</span>
