...
<template>
  <div class="page-container" w-full h-full p="x-4 md:x-8 lg:x-16">
    ...
    <Transition name="content-reveal">
      <div v-if="!loading && contests.length > 0" grid="~ cols-1 md:cols-2 xl:cols-3" gap-4>
        ...
        >
          ...
          <div style="font-size: 0.85em; color: var(--bew-text-2)">
    ...
    <div
      v-if="!loading && !errorMsg && contests.length === 0"
      bg="$bew-content"
      rounded="$bew-radius"
      p-8
      ...
      border="1 $bew-border-color"
    >
      <span style="display: contents" v-html="renderIcon('mingcute:trophy-line', 48)" />
      <p mt-2>
        暂无比赛
      </p>
    </div>
